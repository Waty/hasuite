...
/*        public List<XNA.Point> RopeOffsets
    ...
    public class MobInfo : MapleExtractableInfo
    {
        ...
        public override BoardItem CreateInstance(Layer layer, Board board, int x, int y, int z, bool flip, bool beforeAdding)
        {
            ...
            return new LifeInstance(this, "m", board, x, y, x - UserSettings.Mobrx0Offset, x + UserSettings.Mobrx1Offset, null, UserSettings.defaultMobTime, flip, false, null, null, beforeAdding);
        }
        ...
        {
            if (Image == null) ParseImage();
            return new LifeInstance(this, "m", board, x, y, x - UserSettings.Mobrx0Offset, x + UserSettings.Mobrx1Offset, limitedname, UserSettings.defaultMobTime, flip, hide, info, team, beforeAdding);
        }
