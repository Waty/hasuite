...
namespace HaCreator.MapEditor
{
    public partial class MultiBoard : UserControl, IServiceProvider
    {
        ...
        private void PrepareDevice()
        {
            ...
            //fontEngine = new FontEngine(UserSettings.FontName, UserSettings.FontStyle, UserSettings.FontSize, UserSettings.AntiAliasing, DxDevice);
        ...
        {
            if (((Form)Parent.Parent.Parent).WindowState == FormWindowState.Minimized) return;
        ...
        {
            if (!deviceReady || ((Form)Parent.Parent.Parent).WindowState == FormWindowState.Minimized) return;
            frameCount++;
