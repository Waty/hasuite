    ...
    public partial class Editor : Office2007RibbonForm
    {
        ...
        private void InitializeCustomComponent()
        {
            ...
            KoolkLVItem[] commonItems = new KoolkLVItem[] { 
                miscItemsContainer.createItem(CreateColoredBitmap(Color.FromArgb((int)UserSettings.FootholdColor.PackedValue)), "Foothold", true),
                miscItemsContainer.createItem(CreateColoredBitmap(Color.FromArgb((int)UserSettings.RopeColor.PackedValue)), "Rope", true),
                miscItemsContainer.createItem(CreateColoredBitmap(Color.FromArgb((int)UserSettings.ChairColor.PackedValue)), "Chair", true),
                miscItemsContainer.createItem(CreateColoredBitmap(Color.FromArgb((int)UserSettings.ToolTipColor.PackedValue)), "Tooltip", true)
            };
        ...
        private void showVR_Click(object sender, EventArgs e)
        {
        ...
        private void lifeSearchBox_TextChanged(object sender, EventArgs e)
        {
            ReloadLifeList();
        }
